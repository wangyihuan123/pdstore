...
public class MatchIterator extends StatefulIterator<Map<Variable, Object>> {
	...
	Query query;	
	ArrayList<ArrayList<PDChange<GUID, Object, GUID>>> List_optItr = new ArrayList<ArrayList<PDChange<GUID,Object,GUID>>>();
	boolean isexecuted=true;
	ArrayList<Iterator<List<PDChange<GUID, Object, GUID>>>> optionalIterator;
