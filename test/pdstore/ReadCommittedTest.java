...
public class ReadCommittedTest extends TestCase {
	...
	public final void testReadWriteLink_GUID_GUID() {
		...
		GUID guid1 = new GUID("111decaf111111111111111111111111");
		GUID guid2 = new GUID("222decaf222222222222222222222222");
		GUID guid3 = new GUID("333decaf333333333333333333333333");
		GUID guid4 = new GUID("444decaf444444444444444444444444");
		GUID roleA = new GUID();

		// READ COMMITTED transactions
		/*
		 * t1: guid1 -- roleA -- guid2 t2: guid1 -- roleA -- guid3 t4: guid1 --
		 * roleA -- guid4
		 */
		...
		assertTrue("Could not see the uncommitted changes of itself",
