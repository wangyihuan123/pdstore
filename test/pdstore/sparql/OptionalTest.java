...
public class OptionalTest extends TestCase {
	...
	PDStoreI<GUID, Object, GUID> store = new PDStore("PDStoreSPARQLTest" + Math.random());
	...
	public void setUp() throws Exception {
		...
		hasAge = new GUID("6c1d831083ef11dfbce200217029675e");
		...
		akl = new GUID("6c1d831083ef11dfbce200217029675f");
		hml = new GUID("9c1d831183ef11dfbce200217029671f");
		varZ = new Variable("z");
		varX = new Variable("x");
		varY = new Variable("y");
		varT = new Variable("t");
	...
	public final void test_crosssubjectObject() {
		...
		PDChange<GUID, Object, GUID> w1 = new PDChange<GUID, Object, GUID>(
				ChangeType.LINK_ADDED, transactionID,varX, likes, varY);// varX, likes, varY);
		...
		Iterator<Map<Variable, Object>> assignmentIterator = query1
				.execute(null);
		int count = 0;
	...
	public final void testOptionalsimpletest() {
		...
		PDChange<GUID, Object, GUID> ow3 = new PDChange<GUID, Object, GUID>(
				ChangeType.LINK_ADDED, transactionID, varX, livesin, varB);
		
/*
		PDChange<GUID, Object, GUID> ow2 = new PDChange<GUID, Object, GUID>(
				ChangeType.LINK_ADDED, transactionID, varX, livesin, 23);
		
		//query1.where.add(ow1);
		query1.where.add(ow2);
		*/
	...
	public final void testOptionalTest2() {
		...
		Iterator<Map<Variable, Object>> assignmentIterator = query5
				.execute(null);
		int count = 0;
		while (assignmentIterator.hasNext()) {
			assignmentIterator.next();
		...
		Query optional6_1 = new Query(select, optionalWhere6_1, null, null, store);
		where6.add(w1);
		...
		Query optional7_1 = new Query(select, optionalWhere7_1, null, null, store);
		where7.add(w1);
