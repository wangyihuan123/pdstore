...
public class PDNode implements PDInstance {
	...
	public static final GUID roleInstanceId = new GUID("e44c1e531d9211e1a04700235411d565");
   ...
   /**
	...
	/**
	 * Returns the instance connected to this instance through the role "instance".
	 * @return the connected instance
	 * @throws PDStoreException
	 */
	 public GUID getInstance() throws PDStoreException {
	 	return (GUID)pdWorkingCopy.getInstance(this, roleInstanceId);
	 }

	/**
	 * Returns the instance(s) connected to this instance through the role "instance".
	 * @return the connected instance(s)
	 * @throws PDStoreException
	 */
	 public Collection<GUID> getInstances() throws PDStoreException {
	 	Set<GUID> result = new HashSet<GUID>();
	 	GUID GUIDTypeId = new GUID("538a986c4062db11afc0b95b08f50e2f");
		pdWorkingCopy.getInstances(this, roleInstanceId, GUID.class, GUIDTypeId, result);
	 	return result;
	 }
	 
   /**
	 * Connects this instance to the given instance using role "instance".
	 * If the given instance is null, nothing happens.
	 * @param instance the instance to connect
	 * @throws PDStoreException
	 */
	public void addInstance(GUID instance) throws PDStoreException {

			if (instance != null) {
				
				pdWorkingCopy.addLink(this.id, roleInstanceId, instance);
			}

	}

	/**
	 * Connects this instance to the given instances using role "instance".
	 * If the given collection of instances is null, nothing happens.
	 * @param instance the Collection of instances to connect
	 * @throws PDStoreException
	 */
	public void addInstances(Collection<GUID> instances) throws PDStoreException {
		if (instances == null)
			return;
	...
	/**
	 * Removes the link from this instance through role "instance".
	 * @throws PDStoreException
	 */
	public void removeInstance() throws PDStoreException {
		pdWorkingCopy.removeLink(this.id, roleInstanceId, 
			pdWorkingCopy.getInstance(this, roleInstanceId));
	}

	/**
	 * Removes the link from this instance through role "instance" to the given instance, if the link exists.
	 * If there is no such link, nothing happens.
	 * If the given instance is null, nothing happens.
	 * @throws PDStoreException
	 */
	public void removeInstance(Object instance) throws PDStoreException {
		if (instance == null)
			return;
		pdWorkingCopy.removeLink(this.id, roleInstanceId, instance);
	}


   /**
	 * Connects this instance to the given instance using role "instance".
	 * If there is already an instance connected to this instance through role "instance", the link will be overwritten.
	 * If the given instance is null, an existing link is removed."
	 * @param instance the instance to connect
	 * @throws PDStoreException
	 */
	public void setInstance(GUID instance) throws PDStoreException {
		pdWorkingCopy.setLink(this.id,  roleInstanceId, instance);	
	}
