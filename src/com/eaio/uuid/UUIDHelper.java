...
abstract public class UUIDHelper
{
  ...
  public static void insert (org.omg.CORBA.Any a, GUID that)
  {
  ...
  public static GUID extract (org.omg.CORBA.Any a)
  {
  ...
  public static GUID read (org.omg.CORBA.portable.InputStream istream)
  {
    GUID value = new GUID ();
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, GUID that)
  {
    ostream.write_longlong (that.time);
    ostream.write_longlong (that.clockSeqAndNode);
  }
