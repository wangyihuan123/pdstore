...
public class QueryExecutionTest extends TestCase {
	...
	public final void testXRI() {
		...
		query.where.add(w1);
		Iterator<Map<Variable, Object>> assignmentIterator = query.execute(
				null);

		List<Object> results = new ArrayList<Object>();
		while (assignmentIterator.hasNext()) {
			Map<Variable, Object> result = assignmentIterator.next();
	...
	public void testMetamodel1() {
		...
		Iterator<Map<Variable, Object>> resultSet = query.execute(null);
