...
public class GUID implements Pairable<GUID>, Comparable<GUID>, Serializable {
	...
	private GUID(GUID id) {
		this(id.time, id.clockSeqAndNode);
	}
	...
	public boolean equals(Object obj) {
		...
		GUID t = (GUID) obj;
		return (time == t.time) && (clockSeqAndNode == t.clockSeqAndNode);
	}
	...
	public GUID getBranchID() {
		...
		branchId.time = 0;
		branchId.clockSeqAndNode &= 0x0000FFFFFFFFFFFFL;
		return branchId;
	}
	...
	public static GUID newBranchId() {
		...
		branchId.time = 0;
		branchId.clockSeqAndNode = rnd.nextLong();
		branchId.clockSeqAndNode &= 0x0000FFFFFFFFFFFFL;
		branchId.clockSeqAndNode |= 0x0000010000000000L;
		return branchId;
	}

	public static GUID maxTransactionId() {
		// make sure the maximum transaction is flagged as "durable".
		return new GUID(UUIDGen.encodeTime(Long.MAX_VALUE),
	...
	public static void setBranchId(GUID transactionId, GUID branchId) {
		transactionId.clockSeqAndNode &= 0xFFFF000000000000L;
		transactionId.clockSeqAndNode |= branchId.clockSeqAndNode;
	}
	...
	public GUID getPartner() {
		...
		long lastbit = probe.clockSeqAndNode & maskForFirst;
		if (lastbit != 0) {
			probe.clockSeqAndNode &= (~maskForFirst);
		} else {
			probe.clockSeqAndNode |= maskForFirst;
		}
	...
	public boolean isFirst() {
		long lastbit = clockSeqAndNode & maskForFirst;
		return lastbit == 0;
	}
