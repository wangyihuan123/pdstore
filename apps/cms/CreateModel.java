...
/*
 * TODO
 * Looks like this needs to be called before the application can use the DB model
 * Consider calling this and checking for existence during application startup. 
 * 
 */

public class CreateModel {
	private static final String modelname = "ContentManagementSystem";
	PDStore store = new PDStore(modelname);
	
	// TODO: Why are these static hashes? Consider replacing with function call	
	public final static GUID OPERATION_TYPE_ID = new GUID("920645120d6411e0b45a1cc1dec00ed3");
	public final static GUID SIMPLE_SPATIAL_INFO_TYPE_ID = new GUID("920645110d6411e0b45a1cc1dec00ed3");
	public final static GUID HISTORY_TYPE_ID = new GUID("920645100d6411e0b45a1cc1dec00ed3");
	...
	private void createModel() {
		...
		store.createModel(transaction, CreateModel.HISTORY_MODELID, modelname);
		...
		// TODO: These hardcoded hashes should go! Use GUIDGen class
	...
	public void createDALClasses() {
		...
		PDGen.generateModel(modelname, "apps", copy, "cms.dal");
	}
